...
# API Configuration
API_ID = int(os.environ.get("API_ID", "28912689"))
API_HASH = os.environ.get("API_HASH", "f4c8f3a84ec0b1cae573b34ac185c79b")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")

CREDIT = os.environ.get("CREDIT", "〱ＵＧ▕")
# MongoDB Configuration
DATABASE_NAME = os.environ.get("DATABASE_NAME", "UGxPRO")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://ankush23:NFnJ879SSIeIpxCB@cluster0.ulzzd1m.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "6831195071"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6831195071").split()]  # Default to owner ID
